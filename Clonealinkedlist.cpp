...
class Solution
{
    ...
    Node *arbjoiner(Node *&head){
        Node *temp=head;
        while(temp->next!=NULL){
           temp->next->arb=temp->arb?temp->arb->next:temp->arb;  //MOST IMP LINEEEEE
    ...
    Node *copyList(Node *head)
    {
        ...
        // joining both the linked lists

        Node * joined=joiner(head,newhead);


        //connecting the pairs arbs

        Node * arbjoin=arbjoiner(head);

        //dejoin them 

        return dejoiner(head);
